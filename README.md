# Lights Out With Socket Project

This is a Lights Out game written in python version 3.11.3 and powered by a python sockets. The application is separated into two different sections: client.py and server.py.
...
Your will need to have python3.11 already installed [here](https://www.python.org/).
